-- Derived from the Java schema. Fresh database only; no DROP statements.
SET NAMES utf8mb4;
...
CREATE TABLE IF NOT EXISTS `tb_seckill_voucher`  (
  ...
  `create_time` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `begin_time` timestamp(3) NOT NULL  COMMENT '生效时间',
  `end_time` timestamp(3) NOT NULL  COMMENT '失效时间',
  `update_time` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
...
CREATE TABLE IF NOT EXISTS `tb_voucher_order`  (
  ...
  `create_time` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '下单时间',
  `pay_time` timestamp(3) NULL DEFAULT NULL COMMENT '支付时间',
  `use_time` timestamp(3) NULL DEFAULT NULL COMMENT '核销时间',
  `refund_time` timestamp(3) NULL DEFAULT NULL COMMENT '退款时间',
  `update_time` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
